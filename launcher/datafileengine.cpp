...
{
public:
    DataFileEngineHandlerData(const QString &dataPath)
        : dataDir(dataPath)
    {
...
DataFileEngineHandler::DataFileEngineHandler(const QString &dataPath)
    : d_ptr(0)
{
    DataFileEngineHandlerData *data = new DataFileEngineHandlerData(dataPath);
